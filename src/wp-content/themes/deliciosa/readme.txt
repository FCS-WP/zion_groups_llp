...
WordPress version: required at least 5.0, tested up to 6.2.2
...
Please install and activate it before starting to use the theme Deliciosa.
...
Theme documentation is available on https://deliciosa.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Deliciosa is Fontello.
