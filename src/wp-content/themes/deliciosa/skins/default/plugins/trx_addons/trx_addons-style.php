...
if ( ! function_exists( 'deliciosa_trx_addons_get_css' ) ) {
	add_filter( 'deliciosa_filter_get_css', 'deliciosa_trx_addons_get_css', 10, 2 );
	function deliciosa_trx_addons_get_css( $css, $args ) {
