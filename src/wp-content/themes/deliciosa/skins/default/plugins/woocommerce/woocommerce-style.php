...
if ( ! function_exists( 'deliciosa_woocommerce_get_css' ) ) {
	add_filter( 'deliciosa_filter_get_css', 'deliciosa_woocommerce_get_css', 10, 2 );
	function deliciosa_woocommerce_get_css( $css, $args ) {
...
.tinv-wishlist th,
.tinv-wishlist td,
.tinv-wishlist td:not(.product-action) *,
.woocommerce-error,
.woocommerce-info,
.woocommerce-message,
...
.woocommerce .woocommerce-cart-form table.shop_table tbody td.product-price span.amount,
...
.woocommerce-form-login .form-row label:not(.woocommerce-form__label) {
...
$fdir = deliciosa_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
