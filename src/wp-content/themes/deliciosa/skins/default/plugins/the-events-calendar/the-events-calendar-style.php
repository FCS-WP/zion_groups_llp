...
if ( ! function_exists( 'deliciosa_tribe_events_get_css' ) ) {
	add_filter( 'deliciosa_filter_get_css', 'deliciosa_tribe_events_get_css', 10, 2 );
	function deliciosa_tribe_events_get_css( $css, $args ) {
